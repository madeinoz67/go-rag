...
func TestBatchGetChunks_ValidationAndEdges(t *testing.T) {
	...
	res, err = e.BatchGetChunks([]string{missing, missing})
	if err != nil {
	...
	pre, _ := e.BatchGetChunks([]string{live})
