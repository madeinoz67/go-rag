...
func TestMCP_ToolsListHas9(t *testing.T) {
	...
	for _, want := range []string{"go_rag_query", "go_rag_status", "go_rag_add", "go_rag_init", "go_rag_scan", "go_rag_config", "go_rag_files", "go_rag_dirs", "go_rag_reprocess"} {
		if !names[want] {
