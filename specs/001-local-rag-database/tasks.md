...
- [ ] T030 [US1] Implement hybrid retrieval + RRF in `internal/index/retrieval.go`: embed query → parallel vector top-60 + FTS top-60 → Reciprocal Rank Fusion (`K_vec=40`, `K_fts=60`) → top-K, collapse same-document hits to top-1 by default (research Q8)
